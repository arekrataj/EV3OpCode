...
public final class ClrCount extends Command {
    private static byte OPCODE = (byte) 0xB2;

    private ChainLayerNumber m_chainLayerNumber;
    private MotorBitField m_motorBitField;

    public ClrCount(ChainLayerNumber chainLayerNumber, MotorBitField motorBitField) {
