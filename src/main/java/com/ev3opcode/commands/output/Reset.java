...
public final class Reset extends Command {
    private static byte OPCODE = (byte) 0xA2;

    private ChainLayerNumber m_chainLayerNumber;
    private MotorBitField m_motorBitField;

    public Reset(ChainLayerNumber chainLayerNumber, MotorBitField motorBitField) {
    ...
    public int getSize() {
        ...
        return opCodeSize + chainLayerNumberSize + motorBitFieldSize;
    }
